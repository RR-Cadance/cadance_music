...
- Reddit ad landing page at [reddit/index.html](reddit/index.html) - **NEW (2025-12-21): focused App Store download landing page**
...
## Recent Change (2025-12-24)
- **Blog section**: Added a dedicated `/blog/` section with an index page and initial articles (BarreNotes App Store disappearance timeline, why the name “Cadance”, and why SEO isn’t worth over-optimizing in the AI Overview era).
